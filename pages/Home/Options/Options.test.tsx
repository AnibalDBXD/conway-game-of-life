...
import { Primary } from './Options.stories';
...
describe('<Options />', () => {
  ...
  test("input can't change if pause is true", () => {
    ...
    const columsnAndRowsInput = getByDisplayValue(DEFAULT_VALUES.COLUMUNS_AND_ROWS);
    ...
    act(() => {
      ...
      expect(columsnAndRowsInput).toHaveValue(String(DEFAULT_VALUES.COLUMUNS_AND_ROWS));
    });
  });
});